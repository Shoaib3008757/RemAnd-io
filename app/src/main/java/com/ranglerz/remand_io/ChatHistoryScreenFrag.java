...
public class ChatHistoryScreenFrag extends ListFragment
{
    ...
    {
        if (ChatSearchScreenFrag.m_Service !=null) //if the service is available
        {
            ActiveChatRoom room  = ChatSearchScreenFrag.m_Service.mActiveChatRooms.get(unqiue);
