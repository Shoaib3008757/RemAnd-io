...
public class ChatActivity extends ListActivity
{
    ...
    LocalService mService = ChatSearchScreenFrag.m_Service;   //reference to the service
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mService = ChatSearchScreenFrag.m_Service; //get a reference to the service
    ...
    private void ParseHistoryFileDataAndUpdateListView(String data)
    {
        ...
        for (int i=2; i<length ;i++) //for each msg string
        {
            ...
            ChatMessage msg = new ChatMessage(parsedSingleMsg[1], parsedSingleMsg[2].replace(Constants.ENTER_REPLACEMENT_CHAR, '\n')
                    ...
                    parsedSingleMsg[1].equalsIgnoreCase(StartupCommunicationActivity.ID));
    ...
    private void WriteSelfMessageToHistoryFile(String msg, ActiveChatRoom room)
    {
        ...
        {
            temp = new String[4];
            temp[0] = StartupCommunicationActivity.user_Name;
            temp[1] = StartupCommunicationActivity.ID;
            temp[2] = msg;
    ...
    public void OnSendButtonClicked(View v)
    {
        ...
        {
            text.setText("");  //clear the user's edit-text
            ChatMessage m = new ChatMessage(StartupCommunicationActivity.ID,newMessage, StartupCommunicationActivity.user_Name,
